...
7. Чтобы назначить свой или любой другой аккаунт админом, перейдите в файл \_test_table.py и выполните метод put_admin(mysqldata, 123) где 123 телеграм id нужного пользователя
